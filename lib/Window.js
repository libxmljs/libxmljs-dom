...
Window.prototype = {
        ...
        if (src && src.length > 0) {
            HttpRequest(window, src, function(err, res, data) {
                if (err) {
                    ...
                    console.log("[libxmljs-dom] Executing remote script: "+src);
            ...
            if (type === null || type.toLowerCase().indexOf('text/j') === -1) {
                ...
                console.log("[libxmljs-dom] Executing local script: " + src);
    ...
    matchMedia: function(mediaQuery) {
        ...
        return {
            ...
            addListener: function(listener) {
                //console.log("add media listener", listener.toString())
            },
            removeListener: function(listener) {
                //console.log("remove media listener", listener.toString())
            },
            match: mediaQuery,
            get matches() {
    ...
    onerror: function(message, filename, line, column, err) {
        console.log("[libxmljs-dom] Window.onerror: ", err)
    },
